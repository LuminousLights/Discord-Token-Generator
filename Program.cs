...
namespace Discord_Multi_Token_Generator
{
	internal static class Program
	{
		...
		{
			string value = "";
			string value2 = "     Discord | Token Gen";
			string value3 = "        discord.gg/LuminousLights        ";
			string value4 = "";
			string value5 = "";
			Console.Title = "Discord Tokens Generator | by Luminous";
			...
			else if (selection == "2")
			{
				...
				using (StreamWriter streamWriter2 = new StreamWriter("x" + text2 + "-Random-Tokens.txt"))
				{
					for (int j = 0; j < Convert.ToInt32(text2); j++)
					{
						...
						gened++;
						Console.Title = string.Concat(new object[2] { "Discord - Token Generated: ", gened });
						streamWriter2.WriteLine("OTQ1O1M" + array3[num45] + array3[num46] + array3[num47] + array3[num48] + array3[num49] + array3[num50] + array3[num51] + array3[num52] + array3[num53] + array3[num54] + array3[num55] + array3[num56] + array3[num57] + array3[num58] + array3[num59] + ".XTdL" + array3[num60] + array3[num61] + "." + array4[num62] + array4[num63] + array4[num64] + array4[num65] + array4[num66] + array4[num67] + array4[num68] + array4[num69] + array4[num70] + array4[num71] + array4[num72] + array4[num73] + array4[num74] + array4[num75] + array4[num76] + array4[num77] + array4[num78] + array4[num79] + array4[num80] + array4[num81] + array4[num82] + array4[num83] + array4[num84] + array4[num85] + array4[num86] + array4[num87] + array4[num88]);
						Console.ForegroundColor = ConsoleColor.Cyan;
						Console.WriteLine("OTQ1Og1M" + array3[num45] + array3[num46] + array3[num47] + array3[num48] + array3[num49] + array3[num50] + array3[num51] + array3[num52] + array3[num53] + array3[num54] + array3[num55] + array3[num56] + array3[num57] + array3[num58] + array3[num59] + ".XTdL" + array3[num60] + array3[num61] + "." + array4[num62] + array4[num63] + array4[num64] + array4[num65] + array4[num66] + array4[num67] + array4[num68] + array4[num69] + array4[num70] + array4[num71] + array4[num72] + array4[num73] + array4[num74] + array4[num75] + array4[num76] + array4[num77] + array4[num78] + array4[num79] + array4[num80] + array4[num81] + array4[num82] + array4[num83] + array4[num84] + array4[num85] + array4[num86] + array4[num87] + array4[num88]);
					}
				}
			...
			else if (selection == "4")
			{
				...
				using (StreamWriter streamWriter4 = new StreamWriter("x" + text4 + "-Random-Tokens.txt"))
				{
					for (int l = 0; l < Convert.ToInt32(text4); l++)
					{
						...
						gened++;
						Console.Title = string.Concat(new object[2] { "Discord - Token Generated: ", gened });
						streamWriter4.WriteLine("OTQ1OTA" + array7[num138] + array7[num139] + array7[num140] + array7[num141] + array7[num142] + array7[num143] + array7[num144] + array7[num145] + array7[num146] + array7[num147] + array7[num148] + array7[num149] + array7[num150] + array7[num151] + array7[num152] + array7[num153] + array7[num154] + ".D2GQ" + array7[num155] + array7[num156] + "." + array8[num157] + array8[num158] + array8[num159] + array8[num160] + array8[num161] + array8[num162] + array8[num163] + array8[num164] + array8[num165] + array8[num166] + array8[num167] + array8[num168] + array8[num169] + array8[num170] + array8[num171] + array8[num172] + array8[num173] + array8[num174] + array8[num175] + array8[num176] + array8[num177] + array8[num178] + array8[num179] + array8[num180] + array8[num181] + array8[num182] + array8[num183]);
						Console.ForegroundColor = ConsoleColor.Cyan;
						Console.WriteLine("OTQ1OTA" + array7[num138] + array7[num139] + array7[num140] + array7[num141] + array7[num142] + array7[num143] + array7[num144] + array7[num145] + array7[num146] + array7[num147] + array7[num148] + array7[num149] + array7[num150] + array7[num151] + array7[num152] + array7[num153] + array7[num154] + ".D2GQ" + array7[num155] + array7[num156] + "." + array8[num157] + array8[num158] + array8[num159] + array8[num160] + array8[num161] + array8[num162] + array8[num163] + array8[num164] + array8[num165] + array8[num166] + array8[num167] + array8[num168] + array8[num169] + array8[num170] + array8[num171] + array8[num172] + array8[num173] + array8[num174] + array8[num175] + array8[num176] + array8[num177] + array8[num178] + array8[num179] + array8[num180] + array8[num181] + array8[num182] + array8[num183]);
					}
				}
				Console.WriteLine("Done Generating!");
				Console.WriteLine("Saved " + gened + " Tokens to: " + "Random-Tokens" + ".txt");
			...
			else if (selection == "6")
			{
				...
				using (StreamWriter streamWriter6 = new StreamWriter("x" + text6 + "-Random-Tokens.txt"))
				{
					for (int n = 0; n < Convert.ToInt32(text6); n++)
					{
						...
						gened++;
						Console.Title = string.Concat(new object[2] { "Discord - Token Generated: ", gened });
						streamWriter6.WriteLine("OTQ1ODI" + array11[num230] + array11[num231] + array11[num232] + array11[num233] + array11[num234] + "M" + array11[num235] + array11[num236] + array11[num237] + "ND" + array11[num238] + array11[num239] + "N" + array11[num240] + array11[num241] + array11[num242] + ".Xbi" + array12[num243] + array12[num244] + array12[num245] + "." + array12[num246] + array12[num247] + array12[num248] + array12[num249] + array12[num250] + array12[num251] + array12[num252] + array12[num253] + array12[num254] + array12[num255] + array12[num256] + array12[num257] + array12[num258] + array12[num259] + array12[num260] + array12[num261] + array12[num262] + array12[num263] + array12[num264] + array12[num265] + array12[num266] + array12[num267] + array12[num268] + array12[num269] + array12[num270] + array12[num271] + array12[num272]);
						Console.ForegroundColor = ConsoleColor.Cyan;
						Console.WriteLine("OTQ1ODI" + array11[num230] + array11[num231] + array11[num232] + array11[num233] + array11[num234] + "M" + array11[num235] + array11[num236] + array11[num237] + "ND" + array11[num238] + array11[num239] + "N" + array11[num240] + array11[num241] + array11[num242] + ".Xbi" + array12[num243] + array12[num244] + array12[num245] + "." + array12[num246] + array12[num247] + array12[num248] + array12[num249] + array12[num250] + array12[num251] + array12[num252] + array12[num253] + array12[num254] + array12[num255] + array12[num256] + array12[num257] + array12[num258] + array12[num259] + array12[num260] + array12[num261] + array12[num262] + array12[num263] + array12[num264] + array12[num265] + array12[num266] + array12[num267] + array12[num268] + array12[num269] + array12[num270] + array12[num271] + array12[num272]);
					}
				}
				Console.WriteLine("Done Generating!");
